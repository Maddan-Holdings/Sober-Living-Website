# Sober Living Website (No-code GrapesJS + GitHub Pages)

Use `/builder.html` to design the site visually (full GrapesJS UI with blocks/layers/styles) and publish to live GitHub Pages.
